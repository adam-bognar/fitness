    ...
    Box(
        ...
        Column(
            ...
            Button(
                ...
                Text("Sign up", color = colorResource(id = R.color.button_text_color))
            }
        ...
        TextButton(onClick = {
           viewModel.onSignInClick(open)
            ...
            Text("Already have an account? Sign in here.", color = colorResource(id = R.color.button_color))
        }
    }
}
